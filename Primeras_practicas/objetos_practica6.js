...
console.log('\n','######### Crear Casa con habitantes #########')
function miCasa(color,numero,tamanio,cuartos,habitantes){
    this.color = color;
    this.numero = numero;
...
var cesar= new personas('Cesar','Guzman',27);
var juan = new personas('Juan','Perez',24);
var homero = new personas('Homero','Simpson',34);
var habitantes = [cesar,juan,homero];
var casa1 = new miCasa('Azul',201,'2 pisos',4,habitantes)
console.log(casa1);
casa1.habitantes[0].saludar()
casa1.habitantes[1].saludar()
casa1.habitantes[2].saludar()
